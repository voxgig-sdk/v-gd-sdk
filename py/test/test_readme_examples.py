# VGd SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VGdSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VGdSDK(...) and VGdSDK.test(...) become
#      VGdSDK.test({"entity": {...}}) seeding one mock record (id "test01")
