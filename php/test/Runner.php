...
class VGdTestRunner
{
    ...
    {
        $live = self::getenv('VGD_TEST_LIVE');
        $override = self::getenv('VGD_TEST_OVERRIDE');
        ...
        $explain = self::getenv('VGD_TEST_EXPLAIN');
...
class_alias('VGdTestRunner', 'Runner');
class_alias('VGdHelpers', 'Helpers');
