...
// VGd SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VGdSDK::test)
...
{
    private const SDK_CLASS = 'VGdSDK';
    ...
    private const SDK_BASE = 'vgd_sdk';
