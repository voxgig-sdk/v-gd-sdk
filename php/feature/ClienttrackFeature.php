...
class VGdClienttrackFeature extends VGdBaseFeature
{
    ...
    public function PostConstruct(VGdContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'VGd-SDK';
