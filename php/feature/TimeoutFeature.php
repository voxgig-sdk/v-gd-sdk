...
class VGdTimeoutFeature extends VGdBaseFeature
{
    ...
    private function _with_timeout(VGdContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VGdContext $_ctx, float $ms): void
    {
        $client = $this->client;
