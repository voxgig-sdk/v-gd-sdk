...
// VGd SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class VGdTestFeature extends VGdBaseFeature
{
    ...
    public function init(VGdContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (VGdContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (VGdContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(VGdContext $ctx, $op, $args): array
    {
