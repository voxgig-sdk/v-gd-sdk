# VGd PHP SDK Reference

Complete API reference for the VGd PHP SDK.
...
```php
require_once __DIR__ . '/v-gd_sdk.php';
...
#### `VGdSDK::test($testopts = null, $sdkopts = null)`
...
```php
[$result, $err] = $client->UrlShortening()->load(["id" => "url_shortening_id"]);
```
