...
class VGdFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VGdSDK/1.0)';
    ...
    public static function call(VGdContext $ctx, string $fullurl, array $fetchdef): array
    {
