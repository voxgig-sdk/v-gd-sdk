...
// VGd SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VGdMakeRequest
{
    public static function call(VGdContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VGdResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VGdResponse($fetched);
        } else {
