...
class VGdNetsimFeature extends VGdBaseFeature
{
    ...
    private function _simulate(VGdContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VGdContext $ctx, array $applied): void
    {
        $client = $this->client;
