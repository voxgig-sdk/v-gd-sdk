...
class VGdStreamingFeature extends VGdBaseFeature
{
    ...
    private function _iterate(VGdResult $result): \Generator
    {
    ...
    private function _streamable(VGdContext $ctx): bool
    {
