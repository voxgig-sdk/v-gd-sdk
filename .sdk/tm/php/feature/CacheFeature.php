...
class VGdCacheFeature extends VGdBaseFeature
{
    ...
    private function _through(VGdContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
