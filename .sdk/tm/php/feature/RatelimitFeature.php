...
class VGdRatelimitFeature extends VGdBaseFeature
{
    ...
    private function _acquire(VGdContext $ctx): void
    {
    ...
    private function _track(VGdContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
