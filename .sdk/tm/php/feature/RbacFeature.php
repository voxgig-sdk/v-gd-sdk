...
class VGdRbacFeature extends VGdBaseFeature
{
    ...
    private function _required(VGdContext $ctx): ?string
    {
    ...
    private function _reject(VGdContext $ctx, string $required): void
    {
    ...
    private function _track(VGdContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
