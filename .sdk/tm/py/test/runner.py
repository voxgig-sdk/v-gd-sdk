...
class VGdTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VGdTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = VGdTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = VGdTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
