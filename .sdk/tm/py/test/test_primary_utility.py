...
from projectname_sdk import VGdSDK
from core.spec import VGdSpec
from core.result import VGdResult
from core.response import VGdResponse
from core.operation import VGdOperation
from core.error import VGdError
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = VGdSDK.test(None, None)
        ...
        class TestInitFeature(VGdBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(VGdBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = VGdSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = VGdSDK.test(None, setup_opts)
