...
func registerTools(server *mcp.Server, client *sdk.VGdSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "v-gd_list",
		Description: "List records from VGd. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "v-gd_load",
		Description: "Load a single record from VGd. " +
...
func runOp(client *sdk.VGdSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.VGdSDK, name string) (sdk.VGdEntity, error) {
