...
import { VGdEntityBase } from './VGdEntityBase'
...
class VGdSDK {
  ...
  static test(testoptsarg?: any, sdkoptsarg?: any) {
    ...
    const testsdk = new VGdSDK(sdkopts)
    testsdk._mode = 'test'
  ...
  tester(testopts?: any, sdkopts?: any) {
    return VGdSDK.test(testopts, sdkopts)
  }
  ...
  toString() {
    return 'VGd ' + this._utility.struct.jsonify(this.toJSON())
  }
