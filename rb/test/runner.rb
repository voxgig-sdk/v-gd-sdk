...
module VGdTestRunner
  ...
  def self.env_override(m)
    live = getenv("VGD_TEST_LIVE")
    override = getenv("VGD_TEST_OVERRIDE")
    ...
    explain = getenv("VGD_TEST_EXPLAIN")
    m["VGD_TEST_EXPLAIN"] = explain if explain && !explain.empty?
