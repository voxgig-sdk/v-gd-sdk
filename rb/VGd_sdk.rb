...
class VGdSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = VGdHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = VGdHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, VGdFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = VGdHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = VGdHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = VGdHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = VGdHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
