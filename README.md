...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/v-gd` | `npm install @voxgig-sdk/v-gd` |
| Python | `voxgig-sdk-v-gd` | `pip install voxgig-sdk-v-gd` |
| PHP | `voxgig-sdk/v-gd` | `composer require voxgig-sdk/v-gd` |
| Golang | `github.com/voxgig-sdk/v-gd-sdk/go` | `go get github.com/voxgig-sdk/v-gd-sdk/go` |
| Ruby | `voxgig-sdk-v-gd` | `gem install voxgig-sdk-v-gd` |
| Lua | `voxgig-sdk-v-gd` | `luarocks install voxgig-sdk-v-gd` |
